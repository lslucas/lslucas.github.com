...
*/
	...
	if (file_exists($var['path'].'/mod.r_port_categoria.delete.php')) 
	 include_once $var['path'].'/mod.r_port_categoria.delete.php';
	
	if (file_exists($var['path'].'/mod.r_port_imagem.delete.php')) 
	 include_once $var['path'].'/mod.r_port_imagem.delete.php';

	if (file_exists($var['path'].'/mod.r_port_makingoff.delete.php')) 
	 include_once $var['path'].'/mod.r_port_makingoff.delete.php';
