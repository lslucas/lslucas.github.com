...
//UPLOAD DO MAKINGOFF
    $var['path_makingoff']    = PATH_IMG.'/'.$var['path'].'/makingoff';
    $var['makingoff_folderlist'] = $var['path_makingoff'];



    $field  = array('port_id', 'port_cli_id', 'port_titulo','port_data', 'port_makingoff','port_descricao', 'port_site');
