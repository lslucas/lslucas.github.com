...
<script>
  $(function(){
	...
	************************************/
	...
	/* APAGA MAKINGOFF/ARQUIVO
	************************************/
	$(".trash-makingoff").click(function(event){
	 event.preventDefault();
  	 var id_trash = $(this).attr('id');
  	 var href_trash = $(this).attr('href');

	  $.blockUI({
	   message: "<p>Tem certeza que deseja remover?</p><br><input type='submit' value='sim' id='trash-makingoff-sim'> <input type='button' value='não' id='trash-makingoff-nao'>"
	  });

	// ACAO AO CLICAR EM NaO
	     $("#trash-makingoff-nao").click(function(){
	      $.unblockUI();
	      return false;
	     });
	...
	// ACAO AO CLICAR EM SIM
	     $("#trash-makingoff-sim").click(function(){
