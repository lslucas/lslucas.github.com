...
*/
	...
	if (file_exists($var['path'].'/mod.r_art_categoria.delete.php')) 
	 include_once $var['path'].'/mod.r_art_categoria.delete.php';
	
	if (file_exists($var['path'].'/mod.r_art_imagem.delete.php')) 
	 include_once $var['path'].'/mod.r_art_imagem.delete.php';
